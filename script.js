var currentStep = 1;
        ...
        function switchLanguage(lang) {
            ...
            document.querySelectorAll('#languageButtons .btn-option').forEach(btn => {
        ...
        function updatePageLanguage() {
            ...
            // Update step text
            document.getElementById('stepText').textContent = translations[currentLanguage]['stepOf'].replace('{n}', currentStep);
